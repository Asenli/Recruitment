...
<script>
import { station_data } from '../../api/jian'
...
export default {
  ...
  data() {
    return {
      imageArry: [
        require('../../assets/ranjith-a.jpg'),
        require('../../assets/ranjith.jpg'),
        require('../../assets/vista.jpg')],
      dataList: []
    }
  },
  mounted() {
...
.el-radio.is-bordered + .el-radio /deep/ .is-bordered {
  margin-left: 0;
  margin-top: 5px;
}
